...
import pickle
import numpy as np
#postgresql://postgres.uuyuojpimpjaittgbhcx:[YOUR-PASSWORD]@aws-1-us-east-2.pooler.supabase.com:6543/postgres
#postgresql://postgres.uuyuojpimpjaittgbhcx:[YOUR-PASSWORD]@aws-1-us-east-2.pooler.supabase.com:5432/postgres
import psycopg2
# Fetch variables
USER = "postgres.uuyuojpimpjaittgbhcx" #os.getenv("user")
PASSWORD = "juanalonso/2904"# os.getenv("password")
